...
const Hero = () => {
  return (
    <div className="w-full h-full flex flex-col justify-center bg-white-bg-1 dark:bg-dark-bg-3 p-4 border-4">
      <h2 className="mb-6 font-mono text-base text-left text-neutral-800 dark:text-neutral-300">
        Hi, my name is
      </h2>
      ...
      <p className="mb-6 text-base text-neutral-800 dark:text-neutral-300 w-8/9 sm:w-7/9 md:w-6/9 lg:w-5/9">
