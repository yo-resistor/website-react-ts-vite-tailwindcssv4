...
const Contact = () => {
  ...
  return (
    <div className="max-[200px]:hidden w-full h-full min-h-screen flex flex-col bg-white-bg-1 dark:bg-dark-bg-3 max-sm:px-10 sm:max-lg:px-20 lg:max-2k:px-30 2k:px-40">
      <h2 className="mt-30 mb-6 font-mono text-base text-left text-neutral-800 dark:text-neutral-300">
        Let's
      </h2>
